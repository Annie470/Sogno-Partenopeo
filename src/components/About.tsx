        ...
        <Row className=" d-flex justify-content-center py-4">
          <Col xs={12} md={6} className="text-center">
            ...
            <p className="fs-5">
              ...
              fragrante e leggera, con il suo cornicione alto e morbido, cotta
              nel fuoco vivo del forno a legna come vuole l’arte tramandata da
              generazioni, fino ai piatti della cucina{" "}
